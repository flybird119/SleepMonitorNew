...
public class Alarms {
    ...
    @SuppressLint("NewApi") static void saveSnoozeAlert(final Context context, final int id,
            final long time) {
    ...
    // the window shade.
    @TargetApi(Build.VERSION_CODES.GINGERBREAD) private static void clearSnoozePreference(final Context context,
